...
$(document).ready(function () {
  $("#registrof").submit(function (e) {
    ...
    //aqui queria colocar si correo existe , debe colocar otro//
    //var correoregistro =  $("#registrocorreo").val();//
   // if(Usuario == correoregistro) {//
     // mensajesMostrar += "el correo ya  existe ingrese otro <br>";//
     // entrar = true;//
    // }//
