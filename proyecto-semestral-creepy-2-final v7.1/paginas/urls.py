...
urlpatterns = [
    ...
    path('eliminarcreepy1/<codigos1>', eliminarcreepy1, name="eliminarcreepy1"),
    path('borrarmensajes/<id>', borrarmensajes, name="borrarmensajes"),
    path('borrarusuario/<ide>', borrarusuario, name="borrarusuario"),
    path('borrarcomentarios/<idees>', borrarcomentarios, name="borrarcomentarios"),
    ...
    path('ajustescomentarios/<ideees>', ajustescomentarios, name="ajustescomentarios"),
